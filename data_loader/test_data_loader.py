...
def test_load_colon_data():
    colon_data, colon_data_labels = load_colon_data()
...
def test_load_prostate_data():
    prostate_data, prostate_data_labels = load_prostate_data()
...
def test_load_leukemia_data():
    leukemia_data, leukemia_data_labels = load_leukemia_data()
